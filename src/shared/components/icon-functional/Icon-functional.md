...
<i class="fa fa-fw fas fa-cogs"></i> cogs<br/><br/>
...
<i class="fa fa-fw fas fa-exclamation-square"></i> exclamation-square<br/><br/>
<i class="fa fa-fw fas fa-exclamation-triangle"></i> exclamation-triangle<br/><br/>
<i class="fa fa-fw fas fa-eye"></i> eye<br/><br/>
<i class="fa fa-fw fas fa-file"></i> file<br/><br/>
<i class="fa fa-fw fas fa-file-upload"></i> file upload<br/><br/>
...
<i class="fa fa-fw fas fa-info-circle"></i> info-circle<br/><br/>
<i class="fa fa-fw fas fa-info-square"></i> info-square<br/><br/>
...
<i class="fa fa-fw fas fa-paper-plane"></i> paper-plane<br/><br/>
...
<i class="fa fa-fw fas fa-question-square"></i> question-square<br/><br/>
...
<i class="fa fa-fw far fa-exclamation-circle"></i> exclamation-circle<br/><br/>
<i class="fa fa-fw far fa-file-invoice-dollar"></i> file-invoice-dollar<br/><br/>
<i class="fa fa-fw far fa-info-circle"></i> info-circle<br/><br/>
