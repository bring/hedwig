...
```hint
Functional icons are moving to Font Awesome. This documentation will be deprecated from Hedwig version 8.
Update your code for including functional icons:
[Icon functional](/Icon-functional)

This page is included for legacy reasons.
```
