...
```html|span-6,plain,light
  ...
  <div class="hw-modal" data-hw-modal="Modal1">
    ...
    <div class="hw-modal__window hw-animate hw-animate--slide-in-bottom">
      <div class="hw-block
                  hw-block--mt
                  hw-block--mb">
        <div class="hw-block--full hw-block--mt hw-block--mb">
        ...
        <div class="hw-block--full hw-block--mt-large hw-block--mb">
