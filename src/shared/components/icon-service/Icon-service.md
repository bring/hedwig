...
### Example colors
```html|plain,light
<svg class="hw-icon hw-color-primary" style="width: 20px; height: 20px; margin-right: 10px;">
    <use xlink:href="#bud"></use>
</svg>
<svg class="hw-icon hw-color-green" style="width: 20px; height: 20px; margin-right: 10px;">
    <use xlink:href="#bud"></use>
</svg>
<svg class="hw-icon hw-color-red" style="width: 20px; height: 20px; margin-right: 10px;">
    <use xlink:href="#bud"></use>
</svg>
<svg class="hw-icon hw-color-gray-light" style="width: 20px; height: 20px; margin-right: 10px;">
    <use xlink:href="#bud"></use>
</svg>
<svg class="hw-icon hw-color-gray-darker" style="width: 20px; height: 20px; margin-right: 10px;">
    <use xlink:href="#bud"></use>
</svg>
```
...
<br/>
<svg class="hw-icon" style="width: 31px; height: 20px; margin-right: 10px;">
