...
### Example colors
```html
<svg class="hw-icon hw-color-primary" style="width: 40px; height: 40px;">
    <use xlink:href="#bud"></use>
</svg>
<svg class="hw-icon hw-color-green" style="width: 40px; height: 40px;">
    <use xlink:href="#bud"></use>
</svg>
...
<br/>
<svg class="hw-icon" style="width: 62px; height: 40px;">
