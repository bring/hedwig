...
In addition to being the colour of our logo, signature green is used in digital products as a signal and call-to-action colour in navigation."
```
...
These colours are used sparingly to ensure that our customers easily and consistently can navigate to the information they need, across all platforms, and to enridge the tonal variation of the green Bring universe.
...
These are reserved colours used just for certain hover states.
